...
public class GuiQuickCommandsInGame extends Screen {
    ...
    public void init() {
        ...
        for (int i = 0; i < chatcommands.length; i++) {
            ...
            this.addButton(new Button(this.width / 2 - 125 + 127 * w, 36 + (i - 6 * w) * 24, 125, 20, com, (p) -> {
    ...
    public void render(MatrixStack matrixstack, int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredString(matrixstack, this.font, "Quick Commands", this.width / 2, 16, 16777215);
