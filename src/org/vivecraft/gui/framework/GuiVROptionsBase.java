...
public abstract class GuiVROptionsBase extends Screen {
     ...
     */
    protected void init(VROptionLayout[] settings, boolean clear) { // specify options and layout
        ...
        for (VROptionLayout layout : settings) {
            if (layout.getOption() != null && layout.getOption().getEnumFloat()) { // Option Slider
            ...
            } else if (layout.getOption() != null) { // Option Button
                this.addButton(
            ...
            } else if (layout.getScreen() != null) { // Screen button
            ...
            } else if (layout.getCustomHandler() != null) { // Custom click handler button
                this.addButton(new GuiVROptionButton(layout.getOrdinal(), layout.getX(this.width), layout.getY(this.height), layout.getButtonText(), (p) -> {
    ...
    protected void init(VROptionEntry[] settings, boolean clear) { //auto-layout a list of options.
    ...
    public void render(MatrixStack matrixstack, int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredString(matrixstack, this.font, Lang.get(this.vrTitle), this.width / 2, 15, 16777215);
