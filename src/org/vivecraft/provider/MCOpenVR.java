...
public class MCOpenVR {
    ...
    public static void poll(long frameIndex) {
        ...
        if (!mc.vrSettings.seated) {
            ...
            if (mc.currentScreen == null && mc.vrSettings.vrTouchHotbar && mc.vrSettings.vrHudLockMode != VRSettings.HUD_LOCK_HEAD && hudPopup) {
                processHotbar();
            }
    ...
    private static void updatePose() {
        ...
        if (TPose) {
            ...
            OpenVRUtil.Matrix4fCopy(Matrix4f.rotationY(-120), TPose_Right);
            ...
            TPose_Left.M[1][3] = 0f;
            TPose_Left.M[2][3] = 0f;
            OpenVRUtil.Matrix4fCopy(Matrix4f.rotationY(120), TPose_Left);
            TPose_Left.M[0][3] = -.5f;
    ...
    public static float[] getPlayAreaSize() {
        ...
        if (valid == 1)
            return new float[]{bufx.getValue() * mc.vrSettings.walkMultiplier, bufz.getValue() * mc.vrSettings.walkMultiplier};
        return null;
    }
